...
int main()
{
    /*RomanNumeral rn ("ICMMMMC");

   cout << "The Integer   " << rn.getDecimal()<<endl;


   RomanNumeral rn1 (3000);
   cout << "The String   " << rn.getRoman()<<endl;
...
void test1()
{
   ...
   RomanNumeral r2("MCMXLIX");
    ...
    RomanNumeral r7 = r2/r3;
    RomanNumeral result = r1 + r4;

    /// NEED TO ASK FROM PROFESSOR
